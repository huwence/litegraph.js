(function (global) {
  ...
  LGraphPoints3D.title = i18n("list of points");
  LGraphPoints3D.desc = i18n("returns an array of points");
  ...
  LGraphPointsToInstances.title = i18n("points to inst");
  ...
  LGraphGeometryTransform.title = i18n("Transform");
  ...
  LGraphGeometryPolygon.title = i18n("Polygon");
  ...
  LGraphGeometryExtrude.title = i18n("extrude");
  ...
  LGraphGeometryEval.title = i18n("geoeval");
  LGraphGeometryEval.desc = i18n("eval code");
  ...
  function LGraphGeometryDisplace() {
    ...
    LGraphGeometryDisplace.title = i18n("displace");
    LGraphGeometryDisplace.desc = i18n("displace points");
  ...
  */
  ...
  LGraphConnectPoints.title = i18n("connect points");
  LGraphConnectPoints.desc = i18n("adds indices between near points");
  ...
  LGraphToGeometry.title = i18n("to geometry");
  LGraphToGeometry.desc = i18n("converts a mesh to geometry");
  ...
  LGraphGeometryToMesh.title = i18n("Geo to Mesh");
  ...
  LGraphRenderMesh.title = i18n("Render Mesh");
  LGraphRenderMesh.desc = i18n("renders a mesh flat");
  ...
  LGraphGeometryPrimitive.title = i18n("Primitive");
  ...
  LGraphRenderPoints.title = i18n("renderPoints");
  LGraphRenderPoints.desc = i18n("render points with a texture");
