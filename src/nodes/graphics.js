(function (global) {
  ...
  GraphicsPlot.title = i18n("Plot");
  GraphicsPlot.desc = i18n("Plots data over time");
  ...
  GraphicsImage.title = i18n("Image");
  GraphicsImage.desc = i18n("Image loader");
  ...
  ColorPalette.title = i18n("Palette");
  ColorPalette.desc = i18n("Generates a color");
...
*/
  ...
  ImageFrame.title = i18n("Frame");
  ImageFrame.desc = i18n("Frame viewerew");
  ImageFrame.widgets = [
  ...
  ImageFade.title = i18n("Image fade");
  ImageFade.desc = i18n("Fades between images");
  ImageFade.widgets = [
  ...
  ImageCrop.title = i18n("Crop");
  ImageCrop.desc = i18n("Crop Image");
  ...
  CanvasNode.title = i18n("Canvas");
  CanvasNode.desc = i18n("Canvas to render stuff");
  ...
  DrawImageNode.title = i18n("DrawImage");
  DrawImageNode.desc = i18n("Draws image into a canvas");
  ...
  DrawRectangleNode.title = i18n("DrawRectangle");
  DrawRectangleNode.desc = i18n("Draws rectangle in canvas");
  ...
  ImageVideo.title = i18n("Video");
  ImageVideo.desc = i18n("Video playback");
  ImageVideo.widgets = [
...
*/
  ...
  ImageWebcam.title = i18n("Webcam");
  ImageWebcam.desc = i18n("Webcam image");
