(function (global) {
  ...
  Math3DOperation.title = i18n("Operation");
  Math3DOperation.desc = i18n("Easy math 3D operators");
  Math3DOperation["@OP"] = {
    type: "enum",
    title: "operation",
  ...
  Math3DVec3Scale.title = i18n("vec3_scale");
  Math3DVec3Scale.desc = i18n("scales the components of a vec3");
  ...
  Math3DVec3Length.title = i18n("vec3_length");
  Math3DVec3Length.desc = i18n("returns the module of a vector");
  ...
  Math3DVec3Normalize.title = i18n("vec3_normalize");
  Math3DVec3Normalize.desc = i18n("returns the vector normalized");
  ...
  Math3DVec3Lerp.title = i18n("vec3_lerp");
  Math3DVec3Lerp.desc = i18n("returns the interpolated vector");
  ...
  Math3DVec3Dot.title = i18n("vec3_dot");
  Math3DVec3Dot.desc = i18n("returns the dot product");
  ...
  if (global.glMatrix) {
    ...
    Math3DQuaternion.title = i18n("Quaternion");
    Math3DQuaternion.desc = i18n("quaternion");
    ...
    Math3DRotation.title = i18n("Rotation");
    Math3DRotation.desc = i18n("quaternion rotation");
    ...
    MathEulerToQuat.title = i18n("Euler->Quat");
    MathEulerToQuat.desc = i18n("Converts euler angles (in degrees) to quaternion");
    ...
    MathQuatToEuler.title = i18n("Euler->Quat");
    MathQuatToEuler.desc = i18n("Converts rotX,rotY,rotZ in degrees to quat");
    ...
    Math3DRotateVec3.title = i18n("Rot. Vec3");
    Math3DRotateVec3.desc = i18n("rotate a point");
    ...
    Math3DMultQuat.title = i18n("Mult. Quat");
    Math3DMultQuat.desc = i18n("rotate quaternion");
    ...
    Math3DQuatSlerp.title = i18n("Quat Slerp");
    Math3DQuatSlerp.desc = i18n("quaternion spherical interpolation");
    ...
    Math3DRemapRange.title = i18n("Remap Range");
    Math3DRemapRange.desc = i18n("remap a 3D range");
