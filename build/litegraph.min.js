...
(function(x) {
  x.i18n = function(c) {
    return (window.__i18i18n.zh_CN || {})[c] || c;
  };
})(this)(function(x) {
  function c(a) {
  ...
  h.prototype.adjustMouseEvent = function(a) {
    ...
    a.deltaX = d - this.last_mouse_position[0];
...
(function(x) {
  ...
  p.title = i18n("Subgraph");
  p.desc = i18n("Graph inside a node");
  p.title_color = "#334";
  ...
  l.title = i18n("Input");
  l.desc = i18n("Input of the graph");
  ...
  r.title = i18n("Output");
  r.desc = i18n("Output of the graph");
  ...
  z.title = i18n("Const Number");
  z.desc = i18n("Constant number");
  ...
  h.title = i18n("Const Boolean");
  h.desc = i18n("Constant boolean");
  ...
  H.title = i18n("Const String");
  H.desc = i18n("Constant string");
  H.prototype.getTitle = z.prototype.getTitle;
  H.prototype.onExecute = function() {
    this.setOutputData(0, this.properties.value);
  };
  ...
  B.title = i18n("Const Object");
  B.desc = i18n("Constant Object");
  B.prototype.onExecute = function() {
    this.setOutputData(0, this._object);
  };
  E.registerNodeType("basic/object", B);
  C.title = i18n("Const File");
  C.desc = i18n("Fetches a file from an url");
  ...
  I.title = i18n("Const Data");
  I.desc = i18n("Constant Data");
  ...
  G.title = i18n("Const Array");
  G.desc = i18n("Constant Array");
  ...
  e.title = i18n("Set Array");
  e.desc = i18n("Sets index of array");
  ...
  J.title = i18n("Array[i]");
  J.desc = i18n("Returns an element from an array");
  ...
  F.title = i18n("Table[row][col]");
  F.desc = i18n("Returns an element from a table");
  ...
  y.title = i18n("Object property");
  y.desc = i18n("Outputs the property of an object");
  ...
  L.title = i18n("Object keys");
  L.desc = i18n("Outputs an array with the keys of an object");
  L.prototype.onExecute = function() {
    var a = this.getInputData(0);
    null != a && this.setOutputData(0, Object.keys(a));
  };
  E.registerNodeType("basic/object_keys", L);
  m.title = i18n("Set Object");
  m.desc = i18n("Adds propertiesrty to object");
  ...
  q.title = i18n("Merge Objects");
  q.desc = i18n("Creates an object copying properties from others");
  ...
  k.title = i18n("Variable");
  k.desc = i18n("store/read variable value");
  k.LITEGRAPH = 0;
  k.GRAPH = 1;
  k.GLOBALSCOPE = 2;
  ...
  b.title = i18n("Download");
  b.desc = i18n("Download some data");
  ...
  d.title = i18n("Watch");
  d.desc = i18n("Show value of input");
  d.prototype.onExecute = function() {
    this.inputs[0] && (this.value = this.getInputData(0));
  };
  ...
  f.title = i18n("Cast");
  f.desc = i18n("Allows to connect different types");
  f.prototype.onExecute = function() {
    this.setOutputData(0, this.getInputData(0));
  };
  E.registerNodeType("basic/cast", f);
  g.title = i18n("Console");
  g.desc = i18n("Show value inside the console");
  ...
  n.title = i18n("Alert");
  n.desc = i18n("Show an alert window");
  n.color = "#510";
  ...
  A.title = i18n("Script");
  A.desc = i18n("executes a code (max 100 characters)");
  ...
  M.title = i18n("Compare *");
  M.desc = i18n("evaluates condition between A and B");
...
(function(x) {
  ...
  var e = x.LiteGraph;
  c.title = i18n("Log Event");
  c.desc = i18n("Log event in console");
  c.prototype.onAction = function(c, e, h) {
    console.log(c, e);
  };
  e.registerNodeType("events/log", c);
  p.title = i18n("TriggerEvent");
  p.desc = i18n("Triggers event if input evaluates to true");
  ...
  l.title = i18n("Sequence");
  l.desc = i18n("Triggers a sequence of events when an event arrives");
  l.prototype.getTitle = function() {
    return "";
  };
  ...
  r.title = i18n("Stepper");
  r.desc = i18n("Trigger events sequentially when an tick arrives");
  ...
  z.title = i18n("Filter Event");
  z.desc = i18n("Blocks events that do not match the filter");
  ...
  h.title = i18n("Branch");
  h.desc = i18n("If condition is true, outputs triggers true, otherwise false");
  h.prototype.onExecute = function() {
  ...
  H.title = i18n("Counter");
  H.desc = i18n("Counts events");
  ...
  C.title = i18n("Timer");
  C.desc = i18n("Sends an event every N milliseconds");
  ...
  I.title = i18n("Semaphore Event");
  I.desc = i18n("Until both events are not triggered, it doesnt continue.");
  I.prototype.onExecute = function() {
  ...
  G.title = i18n("Data Store");
  G.desc = i18n("Stores data and only changes when event is received");
  G.prototype.onExecute = function() {
...
(function(x) {
  ...
  p.title = i18n("Toggle");
  p.desc = i18n("Toggles between true or false");
  ...
  l.title = i18n("Number");
  l.desc = i18n("Widget to select number value");
  ...
  r.title = i18n("Combo");
  r.desc = i18n("Widget to select from a list");
  r.prototype.onExecute = function() {
    this.setOutputData(0, this.properties.value);
  };
  ...
  z.title = i18n("Knob");
  z.desc = i18n("Circular controller");
  z.size = [80, 100];
  ...
  H.title = i18n("H.Slider");
  H.desc = i18n("Linear slider controller");
  ...
  B.title = i18n("Progress");
  B.desc = i18n("Shows data in linear progress");
  B.prototype.onExecute = function() {
    var c = this.getInputData(0);
  ...
  C.title = i18n("Text");
  C.desc = i18n("Shows the input value");
  ...
  I.title = i18n("Panel");
  I.desc = i18n("Non interactive panel");
...
(function(x) {
  ...
  var p = x.LiteGraph;
  c.title = i18n("Gamepad");
  c.desc = i18n("gets the input of the gamepad");
  c.CENTER = 0;
  c.LEFT = 1;
  c.RIGHT = 2;
  c.UP = 4;
...
(function(x) {
  ...
  var t = x.LiteGraph;
  c.title = i18n("Converter");
  c.desc = i18n("type A to type B");
  c.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  p.title = i18n("Bypass");
  p.desc = i18n("removes the type");
  p.prototype.onExecute = function() {
    var a = this.getInputData(0);
    this.setOutputData(0, a);
  };
  t.registerNodeType("math/bypass", p);
  l.title = i18n("to Number");
  l.desc = i18n("Cast to number");
  l.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  r.title = i18n("Range");
  r.desc = i18n("Convert a number from one range to another");
  r.prototype.getTitle = function() {
  ...
  h.title = i18n("Noise");
  h.desc = i18n("Random number with temporal continuity");
  h.data = null;
  ...
  H.title = i18n("Spikes");
  H.desc = i18n("spike every random time");
  H.prototype.onExecute = function() {
  ...
  B.title = i18n("Clamp");
  B.desc = i18n("Clamp number between min and max");
  B.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  C.title = i18n("Lerp");
  C.desc = i18n("Linear Interpolation");
  C.prototype.onExecute = function() {
    var a = this.getInputData(0);
    null == a && (a = 0);
    var b = this.getInputData(1);
  ...
  G.title = i18n("Floor");
  G.desc = i18n("Floor number to remove fractional part");
  G.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  e.title = i18n("Frac");
  e.desc = i18n("Returns fractional part");
  e.prototype.onExecute = function() {
    var a = this.getInputData(0);
    null != a && this.setOutputData(0, a % 1);
  };
  t.registerNodeType("math/frac", e);
  J.title = i18n("Smoothstep");
  J.desc = i18n("Smoothstep");
  J.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (void 0 !== a) {
  ...
  y.title = i18n("Gate");
  y.desc = i18n("if v is true, then outputs A, otherwise B");
  y.prototype.onExecute = function() {
    var a = this.getInputData(0);
    this.setOutputData(0, this.getInputData(a ? 1 : 2));
  };
  t.registerNodeType("math/gate", y);
  L.title = i18n("Average");
  L.desc = i18n("Average Filter");
  L.prototype.onExecute = function() {
    var a = this.getInputData(0);
    null == a && (a = 0);
  ...
  m.title = i18n("TendTo");
  m.desc = i18n("moves the output value always closer to the input");
  m.prototype.onExecute = function() {
    var a = this.getInputData(0);
    null == a && (a = 0);
  ...
  q.title = i18n("Operation");
  q.desc = i18n("Easy math operators");
  ...
  k.title = i18n("Compare");
  k.desc = i18n("compares between two values");
  k.prototype.onExecute = function() {
    var a = this.getInputData(0), b = this.getInputData(1);
  ...
  a.title = i18n("Condition");
  a.desc = i18n("evaluates condition between A and B");
  ...
  b.title = i18n("Branch");
  b.desc = i18n("If condition is true, outputs IN in true, otherwise in false");
  b.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  d.title = i18n("Accumulate");
  d.desc = i18n("Increments a value every time");
  d.prototype.onExecute = function() {
  ...
  f.title = i18n("Trigonometry");
  f.desc = i18n("Sin Cos Tan");
  f.prototype.onExecute = function() {
    var a = this.getInputData(0);
    null == a && (a = 0);
  ...
  g.title = i18n("Formula");
  g.desc = i18n("Compute formula");
  g.size = [160, 100];
  L.prototype.onPropertyChanged = function(a, b) {
  ...
  n.title = i18n("Vec2->XY");
  n.desc = i18n("vector 2 to components");
  ...
  A.title = i18n("XY->Vec2");
  A.desc = i18n("components to vector2");
  A.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  u.title = i18n("Vec4->XYZW");
  u.desc = i18n("vector 4 to components");
  ...
  w.title = i18n("XYZW->Vec4");
  w.desc = i18n("components to vector4");
...
(function(x) {
  ...
  var B = x.LiteGraph;
  c.title = i18n("Selector");
  c.desc = i18n("selects an output");
  c.prototype.onDrawBackground = function(c) {
    if (!this.flags.collapsed) {
      c.fillStyle = "#AFB";
  ...
  p.title = i18n("Sequence");
  p.desc = i18n("select one element from a sequence from a string");
  ...
  l.title = i18n("AND");
  l.desc = i18n("Return true if all inputs are true");
  l.prototype.onExecute = function() {
    ret = !0;
  ...
  r.title = i18n("OR");
  r.desc = i18n("Return true if at least one input is true");
  r.prototype.onExecute = function() {
    ret = !1;
    for (inX in this.inputs) {
      if (this.getInputData(inX)) {
  ...
  z.title = i18n("NOT");
  z.desc = i18n("Return the logical negation");
  z.prototype.onExecute = function() {
    var c = !this.getInputData(0);
    this.setOutputData(0, c);
  };
  B.registerNodeType("logic/NOT", z);
  h.title = i18n("bool == bool");
  h.desc = i18n("Compare for logical equality");
  h.prototype.onExecute = function() {
    last = null;
    ret = !0;
    for (inX in this.inputs) {
  ...
  H.title = i18n("Branch");
  H.desc = i18n("Branch execution on condition");
...
(function(x) {
  ...
  }, K.registerNodeType("texture/texture", c), p.title = i18n("Preview"), p.desc = i18n("Show a texture in the graph canvas"), p.allow_preview = !1, p.prototype.onDrawBackground = function(a) {
  ...
  }, K.registerNodeType("texture/preview", p), l.title = i18n("Save"), l.desc = i18n("Save a texture in the repository"), l.prototype.getPreviewTexture = function() {
  ...
  }, K.registerNodeType("texture/save", l), r.widgets_info = {uvcode:{widget:"code"}, pixelcode:{widget:"code"}, precision:{widget:"combo", values:c.MODE_VALUES}}, r.title = i18n("Operation"), r.desc = i18n("Texture shader operation"), r.presets = {}, r.prototype.getExtraMenuOptions = function(a) {
    var b = this;
  ...
  }, K.registerNodeType("texture/operation", r), z.title = i18n("Shader"), z.desc = i18n("Texture shader"), z.widgets_info = {code:{type:"code", lang:"glsl"}, precision:{widget:"combo", values:c.MODE_VALUES}}, z.prototype.onPropertyChanged = function(a, b) {
  ...
  }, z.pixel_shader = "precision highp float;\n\nvarying vec2 v_coord;\nuniform float time; //time in seconds\nuniform vec4 texSize; //tex resolution\nuniform float u_value;\nuniform vec4 u_color;\n\nvoid main() {\n\tvec2 uv = v_coord;\n\tvec3 color = vec3(0.0);\n\t//your code here\n\tcolor.xy=uv;\n\n\tgl_FragColor = vec4(color, 1.0);\n}\n", K.registerNodeType("texture/shader", z), h.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, h.title = i18n("Scale/Offset"), h.desc = i18n("Applies an scaling and offseting"), 
  h.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  }, h.pixel_shader = "precision highp float;\n\t\t\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tvarying vec2 v_coord;\n\t\tuniform vec2 u_scale;\n\t\tuniform vec2 u_offset;\n\t\t\n\t\tvoid main() {\n\t\t\tvec2 uv = v_coord;\n\t\t\tuv = uv / u_scale - u_offset;\n\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t}\n\t\t", K.registerNodeType("texture/scaleOffset", h), H.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, H.title = i18n("Warp"), H.desc = 
  i18n("Texture warp operation"), H.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (this.isOutputConnected(0)) {
      if (this.properties.precision === c.PASS_THROUGH) {
        this.setOutputData(0, a);
  ...
  }, H.pixel_shader = "precision highp float;\n\t\t\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tvarying vec2 v_coord;\n\t\tuniform float u_factor;\n\t\tuniform vec2 u_scale;\n\t\tuniform vec2 u_offset;\n\t\t\n\t\tvoid main() {\n\t\t\tvec2 uv = v_coord;\n\t\t\tuv += ( texture2D(u_textureB, uv).rg - vec2(0.5)) * u_factor * u_scale + u_offset;\n\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t}\n\t\t", K.registerNodeType("texture/warp", H), B.title = i18n("to Viewport"), 
  B.desc = i18n("Texture to viewport"), B._prev_viewport = new Float32Array(4), B.prototype.onDrawBackground = function(a) {
  ...
  B.gamma_pixel_shader = "precision highp float;\n\t\tprecision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform float u_igamma;\n\t\tvoid main() {\n\t\t\tvec4 color = texture2D( u_texture, v_coord);\n\t\t\tcolor.xyz = pow(color.xyz, vec3(u_igamma) );\n\t\t   gl_FragColor = color;\n\t\t}\n\t\t", K.registerNodeType("texture/toviewport", B), C.title = i18n("Copy"), C.desc = i18n("Copy Texture"), C.widgets_info = {size:{widget:"combo", values:[0, 32, 64, 128, 256, 
  512, 1024, 2048]}, precision:{widget:"combo", values:c.MODE_VALUES}}, C.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  }, K.registerNodeType("texture/copy", C), I.title = i18n("Downsample"), I.desc = i18n("Downsample Texture"), I.widgets_info = {iterations:{type:"number", step:1, precision:0, min:0}, precision:{widget:"combo", values:c.MODE_VALUES}}, I.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  K.registerNodeType("texture/downsample", I), G.title = i18n("Resize"), G.desc = i18n("Resize Texture"), G.widgets_info = {iterations:{type:"number", step:1, precision:0, min:0}, precision:{widget:"combo", values:c.MODE_VALUES}}, G.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if ((a || this._temp_texture) && this.isOutputConnected(0) && a && a.texture_type === GL.TEXTURE_2D) {
  ...
  }, K.registerNodeType("texture/resize", G), e.title = i18n("Average"), e.desc = "Compute a partial average (32 random samples) of a texture and stores it as a 1x1 pixel texture.\n If high_quality is true, then it generates the mipmaps first and reads from the lower one.", e.prototype.onExecute = function() {
  ...
  K.registerNodeType("texture/average", e), i18n("MinMax"), i18n("Compute the scene min max"), J.title = i18n("Smooth"), J.desc = i18n("Smooth texture over time"), J.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  }, J.pixel_shader = "precision highp float;\n\t\tprecision highp float;\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tuniform float u_factor;\n\t\tvarying vec2 v_coord;\n\t\t\n\t\tvoid main() {\n\t\t\tgl_FragColor = mix( texture2D( u_texture, v_coord ), texture2D( u_textureB, v_coord ), u_factor );\n\t\t}\n\t\t", K.registerNodeType("texture/temporal_smooth", J), F.title = i18n("Lineal Avg Smooth"), F.desc = i18n("Smooth texture linearly over time"), F["@samples"] = {type:"number", 
  ...
  K.registerNodeType("texture/linear_avg_smooth", F), y.title = i18n("Image to Texture"), y.desc = i18n("Uploads an image to the GPU"), y.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a) {
  ...
  }, K.registerNodeType("texture/imageToTexture", y), L.widgets_info = {texture:{widget:"texture"}, precision:{widget:"combo", values:c.MODE_VALUES}}, L.title = i18n("LUT"), L.desc = i18n("Apply LUT to Texture"), L.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
  ...
  K.registerNodeType("texture/LUT", L), m.widgets_info = {texture:{widget:"texture"}, precision:{widget:"combo", values:c.MODE_VALUES}}, m.title = i18n("Encode"), m.desc = i18n("Apply a texture atlas to encode a texture"), m.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
      if (this.properties.precision === c.PASS_THROUGH || !1 === this.properties.enabled) {
        this.setOutputData(0, a);
  ...
  K.registerNodeType("texture/encode", m), q.title = i18n("Texture to Channels"), q.desc = i18n("Split texture channels"), q.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a) {
  ...
  }, q.pixel_shader = "precision highp float;\n\t\tprecision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform vec4 u_mask;\n\t\t\n\t\tvoid main() {\n\t\t   gl_FragColor = vec4( vec3( length( texture2D(u_texture, v_coord) * u_mask )), 1.0 );\n\t\t}\n\t\t", K.registerNodeType("texture/textureChannels", q), k.title = i18n("Channels to Texture"), k.desc = i18n("Split texture channels"), k.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, k.prototype.onExecute = 
  function() {
  ...
  K.registerNodeType("texture/channelsTexture", k), a.title = i18n("Color"), a.desc = "Generates a 1x1 texture with a constant color", a.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, a.prototype.onDrawBackground = function(a) {
  ...
  }, K.registerNodeType("texture/color", a), b.title = i18n("Gradient"), b.desc = i18n("Generates a gradient"), b["@A"] = {type:"color"}, b["@B"] = {type:"color"}, b["@texture_size"] = {type:"enum", values:[32, 64, 128, 256, 512]}, b.prototype.onExecute = function() {
    gl.disable(gl.BLEND);
    gl.disable(gl.DEPTH_TEST);
  ...
  K.registerNodeType("texture/gradient", b), d.title = i18n("Mix"), d.desc = i18n("Generates a texture mixing two textures"), d.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, d.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (this.isOutputConnected(0)) {
      if (this.properties.precision === c.PASS_THROUGH) {
        this.setOutputData(0, a);
  ...
  K.registerNodeType("texture/mix", d), f.title = i18n("Edges"), f.desc = i18n("Detects edges"), f.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, f.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
      if (this.properties.precision === c.PASS_THROUGH) {
        this.setOutputData(0, a);
  ...
  K.registerNodeType("texture/edges", f), g.title = i18n("Depth Range"), g.desc = i18n("Generates a texture with a depth range"), g.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
      if (a) {
  ...
  K.registerNodeType("texture/depth_range", g), n.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, n.title = i18n("Linear Depth"), n.desc = i18n("Creates a color texture with linear depth"), n.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
  ...
  K.registerNodeType("texture/linear_depth", n), A.title = i18n("Blur"), A.desc = i18n("Blur a texture"), A.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, A.max_iterations = 20, A.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
  ...
  E.title = i18n("Glow"), E.desc = i18n("Filters a texture giving it a glow effect"), E.widgets_info = {iterations:{type:"number", min:0, max:16, step:1, precision:0}, threshold:{type:"number", min:0, max:10, step:0.01, precision:2}, precision:{widget:"combo", values:c.MODE_VALUES}}, E.prototype.onGetInputs = function() {
  ...
  }, K.registerNodeType("texture/glow", E), u.title = i18n("Kuwahara Filter"), u.desc = "Filters a texture giving an artistic oil canvas painting", u.max_radius = 10, u._shaders = [], u.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
      var b = this._temp_texture;
  ...
  K.registerNodeType("texture/kuwahara", u), w.title = i18n("XDoG Filter"), w.desc = "Filters a texture giving an artistic ink style", w.max_radius = 10, w._shaders = [], w.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
      var b = this._temp_texture;
      b && b.width == a.width && b.height == a.height && b.type == a.type || (this._temp_texture = new GL.Texture(a.width, a.height, {type:a.type, format:gl.RGBA, filter:gl.LINEAR}));
  ...
  K.registerNodeType("texture/xDoG", w), t.title = i18n("Webcam"), t.desc = i18n("Webcam texture"), t.is_webcam_open = !1, t.prototype.openStream = function() {
  ...
  }, K.registerNodeType("texture/webcam", t), D.title = i18n("Lens FX"), D.desc = i18n("distortion and chromatic aberration"), D.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, D.prototype.onGetInputs = function() {
    return [["enabled", "boolean"]];
  }, D.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
  ...
  K.registerNodeType("texture/lensfx", D), S.title = i18n("Data->Tex"), S.desc = i18n("Generates or applies a curve to a texture"), S.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, S.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
      if (a) {
  ...
  }, K.registerNodeType("texture/fromdata", S), v.title = i18n("Curve"), v.desc = i18n("Generates or applies a curve to a texture"), v.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, v.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
  ...
  K.registerNodeType("texture/curve", v), P.title = i18n("Exposition"), P.desc = i18n("Controls texture exposition"), P.widgets_info = {exposition:{widget:"slider", min:0, max:3}, precision:{widget:"combo", values:c.MODE_VALUES}}, P.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
      var b = this._temp_texture;
      b && b.width == a.width && b.height == a.height && b.type == a.type || (b = this._temp_texture = new GL.Texture(a.width, a.height, {type:a.type, format:gl.RGBA, filter:gl.LINEAR}));
  ...
  }, P.pixel_shader = "precision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform float u_exposition;\n\t\t\n\t\tvoid main() {\n\t\t\tvec4 color = texture2D( u_texture, v_coord );\n\t\t\tgl_FragColor = vec4( color.xyz * u_exposition, color.a );\n\t\t}", K.registerNodeType("texture/exposition", P), N.title = i18n("Tone Mapping"), N.desc = "Applies Tone Mapping to convert from high to low", N.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, N.prototype.onGetInputs = 
  function() {
    return [["enabled", "boolean"]];
  }, N.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  K.registerNodeType("texture/perlin", Q), O.title = i18n("Canvas2D"), O.desc = i18n("Executes Canvas2D code inside a texture or the viewport."), O.help = "Set width and height to 0 to match viewport size.", O.default_code = "//vars: canvas,ctx,time\nctx.fillStyle='red';\nctx.fillRect(0,0,50,50);\n", O.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}, code:{type:"code"}, width:{type:"number", precision:0, step:1}, height:{type:"number", precision:0, step:1}}, O.prototype.onPropertyChanged = 
  function(a, b) {
    ...
    this.setOutputData(0, f);
  }, K.registerNodeType("texture/canvas2D", O), R.title = i18n("Matte"), R.desc = i18n("Extracts background"), R.widgets_info = {key_color:{widget:"color"}, precision:{widget:"combo", values:c.MODE_VALUES}}, R.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
      if (this.properties.precision === c.PASS_THROUGH) {
        this.setOutputData(0, a);
  ...
  K.registerNodeType("texture/matte", R), T.title = i18n("CubemapToTexture2D"), T.desc = i18n("Transforms a CUBEMAP texture into a TEXTURE2D in Polar Representation"), T.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
...
(function(x) {
  ...
  if ("undefined" != typeof GL) {
    ...
    h.title = i18n("Lens");
    h.desc = i18n("Camera Lens distortion");
    ...
    x.LGraphFXLens = h;
    z.title = i18n("Bokeh");
    z.desc = i18n("applies an Bokeh effect");
    ...
    x.LGraphFXBokeh = z;
    r.title = i18n("FX");
    r.desc = i18n("applies an FX from a list");
    ...
    x.LGraphFXGeneric = r;
    l.title = i18n("Vigneting");
    l.desc = i18n("Vigneting");
...
(function(x) {
  ...
  l.MIDIInterface = p;
  l.title = i18n("MIDI Input");
  l.desc = i18n("Reads MIDI from a input port");
  l.color = "#243";
  ...
  r.MIDIInterface = p;
  r.title = i18n("MIDI Output");
  r.desc = i18n("Sends MIDI to output channel");
  r.color = "#243";
  ...
  z.title = i18n("MIDI Show");
  z.desc = i18n("Shows MIDI in the graph");
  z.color = "#243";
  z.prototype.getTitle = function() {
  ...
  h.title = i18n("MIDI Filter");
  h.desc = i18n("Filters MIDI messages");
  h.color = "#243";
  ...
  H.title = i18n("MIDIEvent");
  H.desc = i18n("Create a MIDI Event");
  H.color = "#243";
  H.prototype.onAction = function(e, h) {
  ...
  B.title = i18n("MIDICC");
  B.desc = i18n("gets a Controller Change");
  B.color = "#243";
  B.prototype.onExecute = function() {
  ...
  C.title = i18n("MIDI Generator");
  C.desc = i18n("Generates a random MIDI note");
  C.color = "#243";
  ...
  I.title = i18n("MIDI Transpose");
  I.desc = i18n("Transpose a MIDI note");
  I.color = "#243";
  ...
  G.title = i18n("MIDI Quantize Pitch");
  G.desc = i18n("Transpose a MIDI note tp fit an scale");
  G.color = "#243";
  ...
  e.title = i18n("MIDI fromFile");
  e.desc = i18n("Plays a MIDI file");
  e.color = "#243";
  ...
  J.title = i18n("MIDI Play");
  J.desc = i18n("Plays a MIDI note");
  J.color = "#243";
  ...
  F.title = i18n("MIDI Keys");
  F.desc = i18n("Keyboard to play notes");
  F.color = "#243";
...
(function(x) {
  ...
  c.desc = i18n("Plays an audio file");
  ...
  p.title = i18n("MediaSource");
  p.desc = i18n("Plays microphone");
  ...
  l.title = i18n("Analyser");
  l.desc = i18n("Audio Analyser");
  ...
  z.title = i18n("Convolver");
  z.desc = i18n("Convolves the signal (used for reverb)");
  ...
  h.title = i18n("DynamicsCompressor");
  h.desc = i18n("Dynamics Compressor");
  ...
  G.title = i18n("BiquadFilter");
  G.desc = i18n("Audio filter");
  ...
  e.title = i18n("Oscillator");
  e.desc = i18n("Oscillator");
  ...
  J.title = i18n("Visualization");
  J.desc = i18n("Audio Visualization");
  ...
  F.title = i18n("Signal");
  F.desc = i18n("extract the signal of some frequency");
  ...
  y.title = i18n("Script");
  y.desc = i18n("apply script to signal");
  m.registerNodeType("audio/script", y);
  L.title = i18n("Destination");
  L.desc = i18n("Audio output");
...
(function(x) {
  ...
  var l = x.LiteGraph;
  c.title = i18n("WebSocket");
  c.desc = i18n("Send data through a websocket");
  ...
  p.title = i18n("SillyClient");
  p.desc = i18n("Connects to SillyServer to broadcast messages");
