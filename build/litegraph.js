(function (global) {
  global.i18n = function(text) {
    var langs = window.__i18i18n['zh_CN'] || {}
    return langs[text] || text
  }
})(this)
...
(function (global) {
  ...
  Subgraph.title = i18n("Subgraph");
  Subgraph.desc = i18n("Graph inside a node");
  ...
  */
  ...
  GraphInput.title = i18n("Input");
  GraphInput.desc = i18n("Input of the graph");
  ...
  GraphOutput.title = i18n("Output");
  GraphOutput.desc = i18n("Output of the graph");
  ...
  ConstantNumber.title = i18n("Const Number");
  ConstantNumber.desc = i18n("Constant number");
  ...
  ConstantBoolean.title = i18n("Const Boolean");
  ConstantBoolean.desc = i18n("Constant boolean");
  ...
  ConstantString.title = i18n("Const String");
  ConstantString.desc = i18n("Constant string");
  ...
  ConstantObject.title = i18n("Const Object");
  ConstantObject.desc = i18n("Constant Object");
  ...
  ConstantFile.title = i18n("Const File");
  ConstantFile.desc = i18n("Fetches a file from an url");
  ...
  ConstantData.title = i18n("Const Data");
  ConstantData.desc = i18n("Constant Data");
  ...
  ConstantArray.title = i18n("Const Array");
  ConstantArray.desc = i18n("Constant Array");
  ...
  SetArray.title = i18n("Set Array");
  SetArray.desc = i18n("Sets index of array");
  ...
  ArrayElement.title = i18n("Array[i]");
  ArrayElement.desc = i18n("Returns an element from an array");
  ...
  TableElement.title = i18n("Table[row][col]");
  TableElement.desc = i18n("Returns an element from a table");
  ...
  ObjectProperty.title = i18n("Object property");
  ObjectProperty.desc = i18n("Outputs the property of an object");
  ...
  ObjectKeys.title = i18n("Object keys");
  ObjectKeys.desc = i18n("Outputs an array with the keys of an object");
  ...
  SetObject.title = i18n("Set Object");
  SetObject.desc = i18n("Adds propertiesrty to object");
  ...
  MergeObjects.title = i18n("Merge Objects");
  MergeObjects.desc = i18n("Creates an object copying properties from others");
  ...
  Variable.title = i18n("Variable");
  Variable.desc = i18n("store/read variable value");
  ...
  DownloadData.title = i18n("Download");
  DownloadData.desc = i18n("Download some data");
  ...
  Watch.title = i18n("Watch");
  Watch.desc = i18n("Show value of input");
  ...
  Cast.title = i18n("Cast");
  Cast.desc = i18n("Allows to connect different types");
  ...
  Console.title = i18n("Console");
  Console.desc = i18n("Show value inside the console");
  ...
  Alert.title = i18n("Alert");
  Alert.desc = i18n("Show an alert window");
  Alert.color = "#510";
  ...
  NodeScript.title = i18n("Script");
  NodeScript.desc = i18n("executes a code (max 100 characters)");
  ...
  GenericCompare.title = i18n("Compare *");
  GenericCompare.desc = i18n("evaluates condition between A and B");
...
(function (global) {
  ...
  LogEvent.title = i18n("Log Event");
  LogEvent.desc = i18n("Log event in console");
  ...
  TriggerEvent.title = i18n("TriggerEvent");
  TriggerEvent.desc = i18n("Triggers event if input evaluates to true");
  ...
  Sequence.title = i18n("Sequence");
  Sequence.desc = i18n("Triggers a sequence of events when an event arrives");
  ...
  Stepper.title = i18n("Stepper");
  Stepper.desc = i18n("Trigger events sequentially when an tick arrives");
  ...
  FilterEvent.title = i18n("Filter Event");
  FilterEvent.desc = i18n("Blocks events that do not match the filter");
  ...
  EventBranch.title = i18n("Branch");
  EventBranch.desc = i18n("If condition is true, outputs triggers true, otherwise false");
  ...
  EventCounter.title = i18n("Counter");
  EventCounter.desc = i18n("Counts events");
  ...
  DelayEvent.title = i18n("Delay");
  DelayEvent.desc = i18n("Delays one event");
  ...
  TimerEvent.title = i18n("Timer");
  TimerEvent.desc = i18n("Sends an event every N milliseconds");
  ...
  SemaphoreEvent.title = i18n("Semaphore Event");
  SemaphoreEvent.desc = i18n("Until both events are not triggered, it doesnt continue.");
  ...
  DataStore.title = i18n("Data Store");
  DataStore.desc = i18n("Stores data and only changes when event is received");
...
(function (global) {
  ...
  WidgetButton.title = i18n("Button");
  WidgetButton.desc = i18n("Triggers an event");
  ...
  WidgetToggle.title = i18n("Toggle");
  WidgetToggle.desc = i18n("Toggles between true or false");
  ...
  WidgetNumber.title = i18n("Number");
  WidgetNumber.desc = i18n("Widget to select number value");
  ...
  WidgetCombo.title = i18n("Combo");
  WidgetCombo.desc = i18n("Widget to select from a list");
  ...
  WidgetKnob.title = i18n("Knob");
  WidgetKnob.desc = i18n("Circular controller");
  ...
  WidgetSliderGUI.title = i18n("Inner Slider");
  ...
  WidgetHSlider.title = i18n("H.Slider");
  WidgetHSlider.desc = i18n("Linear slider controller");
  ...
  WidgetProgress.title = i18n("Progress");
  WidgetProgress.desc = i18n("Shows data in linear progress");
  ...
  WidgetText.title = i18n("Text");
  WidgetText.desc = i18n("Shows the input value");
  WidgetText.widgets = [
  ...
  WidgetPanel.title = i18n("Panel");
  WidgetPanel.desc = i18n("Non interactive panel");
...
(function (global) {
  ...
  GamepadInput.title = i18n("Gamepad");
  GamepadInput.desc = i18n("gets the input of the gamepad");
...
(function (global) {
  ...
  Converter.title = i18n("Converter");
  Converter.desc = i18n("type A to type B");
  ...
  Bypass.title = i18n("Bypass");
  Bypass.desc = i18n("removes the type");
  ...
  ToNumber.title = i18n("to Number");
  ToNumber.desc = i18n("Cast to number");
  ...
  MathRange.title = i18n("Range");
  MathRange.desc = i18n("Convert a number from one range to another");
  ...
  MathRand.title = i18n("Rand");
  MathRand.desc = i18n("Random number");
  ...
  MathNoise.title = i18n("Noise");
  MathNoise.desc = i18n("Random number with temporal continuity");
  MathNoise.data = null;
  ...
  MathSpikes.title = i18n("Spikes");
  MathSpikes.desc = i18n("spike every random time");
  ...
  MathClamp.title = i18n("Clamp");
  MathClamp.desc = i18n("Clamp number between min and max");
  ...
  MathLerp.title = i18n("Lerp");
  MathLerp.desc = i18n("Linear Interpolation");
  ...
  MathAbs.title = i18n("Abs");
  MathAbs.desc = i18n("Absolute");
  ...
  MathFloor.title = i18n("Floor");
  MathFloor.desc = i18n("Floor number to remove fractional part");
  ...
  MathFrac.title = i18n("Frac");
  MathFrac.desc = i18n("Returns fractional part");
  ...
  MathSmoothStep.title = i18n("Smoothstep");
  MathSmoothStep.desc = i18n("Smoothstep");
  ...
  MathScale.title = i18n("Scale");
  MathScale.desc = i18n("v * factor");
  ...
  Gate.title = i18n("Gate");
  Gate.desc = i18n("if v is true, then outputs A, otherwise B");
  ...
  MathAverageFilter.title = i18n("Average");
  MathAverageFilter.desc = i18n("Average Filter");
  ...
  MathTendTo.title = i18n("TendTo");
  MathTendTo.desc = i18n("moves the output value always closer to the input");
  ...
  MathOperation.title = i18n("Operation");
  MathOperation.desc = i18n("Easy math operators");
  MathOperation["@OP"] = {
    type: "enum",
    title: "operation",
  ...
  MathCompare.title = i18n("Compare");
  MathCompare.desc = i18n("compares between two values");
  ...
  MathCondition.title = i18n("Condition");
  MathCondition.desc = i18n("evaluates condition between A and B");
  ...
  MathBranch.title = i18n("Branch");
  MathBranch.desc = i18n("If condition is true, outputs IN in true, otherwise in false");
  ...
  MathAccumulate.title = i18n("Accumulate");
  MathAccumulate.desc = i18n("Increments a value every time");
  ...
  MathTrigonometry.title = i18n("Trigonometry");
  MathTrigonometry.desc = i18n("Sin Cos Tan");
  ...
  MathFormula.title = i18n("Formula");
  MathFormula.desc = i18n("Compute formula");
  ...
  Math3DVec2ToXY.title = i18n("Vec2->XY");
  Math3DVec2ToXY.desc = i18n("vector 2 to components");
  ...
  Math3DXYToVec2.title = i18n("XY->Vec2");
  Math3DXYToVec2.desc = i18n("components to vector2");
  ...
  Math3DVec3ToXYZ.title = i18n("Vec3->XYZ");
  Math3DVec3ToXYZ.desc = i18n("vector 3 to components");
  ...
  Math3DXYZToVec3.title = i18n("XYZ->Vec3");
  Math3DXYZToVec3.desc = i18n("components to vector3");
  ...
  Math3DVec4ToXYZW.title = i18n("Vec4->XYZW");
  Math3DVec4ToXYZW.desc = i18n("vector 4 to components");
  ...
  Math3DXYZWToVec4.title = i18n("XYZW->Vec4");
  Math3DXYZWToVec4.desc = i18n("components to vector4");
...
(function (global) {
  ...
  Selector.title = i18n("Selector");
  Selector.desc = i18n("selects an output");
  ...
  Sequence.title = i18n("Sequence");
  Sequence.desc = i18n("select one element from a sequence from a string");
  ...
  logicAnd.title = i18n("AND");
  logicAnd.desc = i18n("Return true if all inputs are true");
  ...
  logicOr.title = i18n("OR");
  logicOr.desc = i18n("Return true if at least one input is true");
  ...
  logicNot.title = i18n("NOT");
  logicNot.desc = i18n("Return the logical negation");
  ...
  logicCompare.title = i18n("bool == bool");
  logicCompare.desc = i18n("Compare for logical equality");
  ...
  logicBranch.title = i18n("Branch");
  logicBranch.desc = i18n("Branch execution on condition");
...
(function (global) {
  ...
  LGraphTexture.title = i18n("Texture");
  LGraphTexture.desc = i18n("Texture");
  ...
  LGraphTexturePreview.title = i18n("Preview");
  LGraphTexturePreview.desc = i18n("Show a texture in the graph canvas");
  ...
  LGraphTextureSave.title = i18n("Save");
  LGraphTextureSave.desc = i18n("Save a texture in the repository");
  ...
  LGraphTextureOperation.title = i18n("Operation");
  LGraphTextureOperation.desc = i18n("Texture shader operation");
  ...
  LGraphTextureShader.title = i18n("Shader");
  LGraphTextureShader.desc = i18n("Texture shader");
...
";
  ...
  LGraphTextureScaleOffset.title = i18n("Scale/Offset");
  LGraphTextureScaleOffset.desc = i18n("Applies an scaling and offseting");
  ...
  LGraphTextureWarp.title = i18n("Warp");
  LGraphTextureWarp.desc = i18n("Texture warp operation");
  ...
  LGraphTextureToViewport.title = i18n("to Viewport");
  LGraphTextureToViewport.desc = i18n("Texture to viewport");
  ...
  LGraphTextureCopy.title = i18n("Copy");
  LGraphTextureCopy.desc = i18n("Copy Texture");
  ...
  LGraphTextureDownsample.title = i18n("Downsample");
  LGraphTextureDownsample.desc = i18n("Downsample Texture");
  ...
  LGraphTextureResize.title = i18n("Resize");
  LGraphTextureResize.desc = i18n("Resize Texture");
  ...
  LGraphTextureAverage.title = i18n("Average");
  ...
  LGraphTextureMinMax.title = i18n("MinMax");
  LGraphTextureMinMax.desc = i18n("Compute the scene min max");
  ...
  LGraphTextureTemporalSmooth.title = i18n("Smooth");
  LGraphTextureTemporalSmooth.desc = i18n("Smooth texture over time");
  ...
  LGraphTextureLinearAvgSmooth.title = i18n("Lineal Avg Smooth");
  LGraphTextureLinearAvgSmooth.desc = i18n("Smooth texture linearly over time");
  ...
  LGraphImageToTexture.title = i18n("Image to Texture");
  LGraphImageToTexture.desc = i18n("Uploads an image to the GPU");
  ...
  LGraphTextureLUT.title = i18n("LUT");
  LGraphTextureLUT.desc = i18n("Apply LUT to Texture");
  ...
  LGraphTextureEncode.title = i18n("Encode");
  LGraphTextureEncode.desc = i18n("Apply a texture atlas to encode a texture");
  ...
  LGraphTextureChannels.title = i18n("Texture to Channels");
  LGraphTextureChannels.desc = i18n("Split texture channels");
  ...
  LGraphChannelsTexture.title = i18n("Channels to Texture");
  LGraphChannelsTexture.desc = i18n("Split texture channels");
  ...
  LGraphTextureColor.title = i18n("Color");
  ...
  LGraphTextureGradient.title = i18n("Gradient");
  LGraphTextureGradient.desc = i18n("Generates a gradient");
  ...
  LGraphTextureMix.title = i18n("Mix");
  LGraphTextureMix.desc = i18n("Generates a texture mixing two textures");
  ...
  LGraphTextureEdges.title = i18n("Edges");
  LGraphTextureEdges.desc = i18n("Detects edges");
  ...
  LGraphTextureDepthRange.title = i18n("Depth Range");
  LGraphTextureDepthRange.desc = i18n("Generates a texture with a depth range");
  ...
  LGraphTextureLinearDepth.title = i18n("Linear Depth");
  LGraphTextureLinearDepth.desc = i18n("Creates a color texture with linear depth");
  ...
  LGraphTextureBlur.title = i18n("Blur");
  LGraphTextureBlur.desc = i18n("Blur a texture");
...
*/
  ...
  LGraphTextureGlow.title = i18n("Glow");
  LGraphTextureGlow.desc = i18n("Filters a texture giving it a glow effect");
  ...
  LGraphTextureKuwaharaFilter.title = i18n("Kuwahara Filter");
...
";
  ...
  LGraphTextureXDoGFilter.title = i18n("XDoG Filter");
...
void main(void){\n\
  ...
  LGraphTextureWebcam.title = i18n("Webcam");
  LGraphTextureWebcam.desc = i18n("Webcam texture");
  ...
  LGraphLensFX.title = i18n("Lens FX");
  LGraphLensFX.desc = i18n("distortion and chromatic aberration");
  ...
  LGraphTextureFromData.title = i18n("Data->Tex");
  LGraphTextureFromData.desc = i18n("Generates or applies a curve to a texture");
  ...
  LGraphTextureCurve.title = i18n("Curve");
  LGraphTextureCurve.desc = i18n("Generates or applies a curve to a texture");
  ...
  LGraphExposition.title = i18n("Exposition");
  LGraphExposition.desc = i18n("Controls texture exposition");
  ...
  LGraphToneMapping.title = i18n("Tone Mapping");
  ...
  LGraphTexturePerlin.title = i18n("Perlin");
  LGraphTexturePerlin.desc = i18n("Generates a perlin noise texture");
  ...
  LGraphTextureCanvas2D.title = i18n("Canvas2D");
  LGraphTextureCanvas2D.desc = i18n("Executes Canvas2D code inside a texture or the viewport.");
  ...
  LGraphTextureMatte.title = i18n("Matte");
  LGraphTextureMatte.desc = i18n("Extracts background");
  ...
  LGraphCubemapToTexture2D.title = i18n("CubemapToTexture2D");
  LGraphCubemapToTexture2D.desc = i18n("Transforms a CUBEMAP texture into a TEXTURE2D in Polar Representation");
...
(function (global) {
  ...
  if (typeof GL != "undefined") {
    ...
    LGraphFXLens.title = i18n("Lens");
    LGraphFXLens.desc = i18n("Camera Lens distortion");
...
LGraphDepthOfField.title = i18n("Depth Of Field");
LGraphDepthOfField.desc = i18n("Applies a depth of field effect");
...
*/
    ...
    LGraphFXBokeh.title = i18n("Bokeh");
    LGraphFXBokeh.desc = i18n("applies an Bokeh effect");
...
*/
    ...
    LGraphFXGeneric.title = i18n("FX");
    LGraphFXGeneric.desc = i18n("applies an FX from a list");
    ...
    LGraphFXVigneting.title = i18n("Vigneting");
    LGraphFXVigneting.desc = i18n("Vigneting");
...
(function (global) {
  ...
  LGMIDIIn.title = i18n("MIDI Input");
  LGMIDIIn.desc = i18n("Reads MIDI from a input port");
  ...
  LGMIDIOut.title = i18n("MIDI Output");
  LGMIDIOut.desc = i18n("Sends MIDI to output channel");
  ...
  LGMIDIShow.title = i18n("MIDI Show");
  LGMIDIShow.desc = i18n("Shows MIDI in the graph");
  ...
  LGMIDIFilter.title = i18n("MIDI Filter");
  LGMIDIFilter.desc = i18n("Filters MIDI messages");
  ...
  LGMIDIEvent.title = i18n("MIDIEvent");
  LGMIDIEvent.desc = i18n("Create a MIDI Event");
  ...
  LGMIDICC.title = i18n("MIDICC");
  LGMIDICC.desc = i18n("gets a Controller Change");
  ...
  LGMIDIGenerator.title = i18n("MIDI Generator");
  LGMIDIGenerator.desc = i18n("Generates a random MIDI note");
  ...
  LGMIDITranspose.title = i18n("MIDI Transpose");
  LGMIDITranspose.desc = i18n("Transpose a MIDI note");
  ...
  LGMIDIQuantize.title = i18n("MIDI Quantize Pitch");
  LGMIDIQuantize.desc = i18n("Transpose a MIDI note tp fit an scale");
  ...
  LGMIDIFromFile.title = i18n("MIDI fromFile");
  LGMIDIFromFile.desc = i18n("Plays a MIDI file");
  ...
  LGMIDIPlay.title = i18n("MIDI Play");
  LGMIDIPlay.desc = i18n("Plays a MIDI note");
  ...
  LGMIDIKeys.title = i18n("MIDI Keys");
  LGMIDIKeys.desc = i18n("Keyboard to play notes");
...
(function (global) {
  ...
  LGAudioSource.desc = i18n("Plays an audio file");
  ...
  LGAudioSource.title = i18n("Source");
  LGAudioSource.desc = i18n("Plays audio");
  ...
  LGAudioMediaSource.title = i18n("MediaSource");
  LGAudioMediaSource.desc = i18n("Plays microphone");
  ...
  LGAudioAnalyser.title = i18n("Analyser");
  LGAudioAnalyser.desc = i18n("Audio Analyser");
  ...
  LGAudioGain.title = i18n("Gain");
  LGAudioGain.desc = i18n("Audio gain");
  ...
  LGAudioConvolver.title = i18n("Convolver");
  LGAudioConvolver.desc = i18n("Convolves the signal (used for reverb)");
  ...
  LGAudioDynamicsCompressor.title = i18n("DynamicsCompressor");
  LGAudioDynamicsCompressor.desc = i18n("Dynamics Compressor");
  LiteGraph.registerNodeType(
...
LGAudioWaveShaper.title = i18n("WaveShaper");
LGAudioWaveShaper.desc = i18n("Distortion using wave shape");
...
*/
  ...
  LGAudioMixer.title = i18n("Mixer");
  LGAudioMixer.desc = i18n("Audio mixer");
  ...
  LGAudioADSR.title = i18n("ADSR");
  LGAudioADSR.desc = i18n("Audio envelope");
  ...
  LGAudioDelay.title = i18n("Delay");
  LGAudioDelay.desc = i18n("Audio delay");
  ...
  LGAudioBiquadFilter.title = i18n("BiquadFilter");
  LGAudioBiquadFilter.desc = i18n("Audio filter");
  ...
  LGAudioOscillatorNode.title = i18n("Oscillator");
  LGAudioOscillatorNode.desc = i18n("Oscillator");
  ...
  LGAudioVisualization.title = i18n("Visualization");
  LGAudioVisualization.desc = i18n("Audio Visualization");
  ...
  LGAudioBandSignal.title = i18n("Signal");
  LGAudioBandSignal.desc = i18n("extract the signal of some frequency");
  ...
  LGAudioScript.title = i18n("Script");
  LGAudioScript.desc = i18n("apply script to signal");
  ...
  LGAudioDestination.title = i18n("Destination");
  LGAudioDestination.desc = i18n("Audio output");
...
(function (global) {
  ...
  LGWebSocket.title = i18n("WebSocket");
  LGWebSocket.desc = i18n("Send data through a websocket");
  ...
  LGSillyClient.title = i18n("SillyClient");
  LGSillyClient.desc = i18n("Connects to SillyServer to broadcast messages");
